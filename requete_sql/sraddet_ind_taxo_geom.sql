create materialized view orb_indicateurs.mv_sraddet_ind_taxo_geom as (
select   t.group2_inpn as declinaison,															-- liste des groupes de taxonomies
		 la.geom,																				-- maille 5x5
		 ...
		 case when EXTRACT(YEAR FROM s.date_min) BETWEEN 2001 AND 2005 then '2001 - 2005'
		 	  ...
		 	  when EXTRACT(YEAR FROM s.date_min) BETWEEN 2021 AND 2025 then '2021 - 2025' end as annee_group,
