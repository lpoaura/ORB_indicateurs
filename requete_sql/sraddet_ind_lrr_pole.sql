create materialized view orb_indicateurs.mv_sraddet_ind_lrr_pole as (
select  case when  t.regne = 'Animalia' and t.phylum != 'Chordata' then 'Invertébrés'
			   ...
			   when  t.regne != 'Animalia' then 'Flore et Fongus' end declinaison,
	left(bs.code_statut,2) as code_statut,		
